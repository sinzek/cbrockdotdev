			...
			<CDialogContent>
				<div className="flex flex-col-reverse gap-4 lg:gap-0 lg:grid lg:grid-cols-2">
					<div className="flex flex-col gap-3 lg:gap-4 max-h-[60vh] lg:max-h-[67vh] overflow-y-auto lg:pr-6 pb-24 lg:pb-0 text-base 4xl:text-lg font-light font-sans text-foreground/75">
						...
						<p>
							When a filming or release date on an idea is set, it
							is added to the content calendar as an event. This
							allows the user to see their entire content schedule
							at a glance, making it easier to plan and manage
							their time effectively. Selecting an event will open
							its corresponding idea, which can then be edited or
							updated as needed. Events can be dragged, resized,
							and even created by selecting days on the calendar,
							which will create a new idea with filming dates of
							what was selected.
						</p>
						<p className="mt-4">
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
							<div className="flex flex-col gap-2">
								...
								<p className="text-sm text-foreground/50 ">
									Select a single day or a range of days. To
									add another day, click the + icon next to
									the first date range field. Previously
									selected days will be grayed out, so you
									have a visual indicator of which days are
									already selected.
								</p>
							</div>
							<div className="flex flex-col gap-2">
								...
								/>
								<p className="text-sm text-foreground/50">
									Select a single day and time. There are
									provided presets for today, tomorrow, and
									next week. If a filming date is present,
									three more presets will appear: 1 week after
									filming, 2 weeks after filming, and 1 month
									after filming.
								</p>
							</div>
						</div>
						<p>
							Once date(s) are selected for either field, a
							corresponding calendar event will be created for one
						...
						<div className="flex flex-col-reverse lg:flex-row items-center gap-6">
							...
							<div className="flex-col gap-2 4xl:text-lg text-base font-light font-sans text-foreground/50">
								<p>
									Select a color for the event. The selected
									color will be used to highlight the event in
									the calendar. <br />
									<br />
								</p>
								<p>
									The color picker supports a wide range of
									colors, allowing users to choose a color
									that best fits their needs. It includes a
									saturation selector, a hue slider, a list of
									your saved colors, and a button to navigate
									to the settings page to manage your saved
									colors. <br />
									<br />
