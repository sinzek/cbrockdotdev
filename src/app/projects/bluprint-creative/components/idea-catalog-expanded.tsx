			...
			<CDialogContent>
				<div className="grid grid-cols-1 lg:grid-cols-2">
					...
					<div className="flex flex-col gap-4 max-h-[71vh] overflow-y-auto pl-6 pr-2 text-base 4xl:text-lg font-light font-sans text-foreground/75">
						...
						<p>
							The idea catalog is meant to be the central hub for
						...
						<ul className="list-disc pl-6 space-y-2">
							<li>
								...
								Ideas can be filtered by their status, category,
								whether they are marked as archived, and whether
								the title includes the current search term
								entered into the search bar. These filters can
								be combined to narrow down the list of displayed
								ideas.
							...
							<li>
								...
								Ideas can be sorted by the date they were last
								updated (by default), the date they were
								created, or by their title, all in both
								ascending and descending order. Combined with
								filters, this allows users to quickly find the
							...
							<li>
								...
								Multiple ideas can be selected at once, and bulk
								actions can be performed on them. These include
								adding a specified category or status,
							...
							<li>
								...
								Categories are displayed at the top of the
								catalog, and selecting one will show only the
								ideas within that category. This allows users to
								quickly find ideas related to a specific topic
								or theme.
							</li>
							<li>
								<strong className="text-red font-bold">
								...
								When you hover over an idea in the grid view,
								three dots will appear on the top right corner.
								Clicking on these dots will open a quick-edit
								menu of of the idea&apos;s attributes that are
								changed most frequently (according to
								user/client feedback). At the top right of the
								quick edit menu, there is a button to open the
								full idea as well as one to pin the idea to the
								dashboard.
								<Image
							...
							<li>
								...
								Ideas can be pinned to the &quot;Pinned
								ideas&quot; section of the dashboard for quick
								access and easy separation.
							</li>
						</ul>
