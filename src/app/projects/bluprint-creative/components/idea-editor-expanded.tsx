...
import { CirclesThreeIcon, EyeIcon, LightbulbFilamentIcon, WrenchIcon } from "@phosphor-icons/react";
			...
			<CDialogContent>
				<div className="grid grid-cols-1 lg:grid-cols-5 gap-2 lg:gap-0">
					...
					<div className="lg:col-span-3 flex flex-col gap-4 max-h-[60vh] lg:max-h-[75vh] overflow-y-auto lg:pl-6 lg:pr-2 lg:pb-0 pb-12 text-base 4xl:text-lg font-light font-sans text-foreground/75">
						...
						<p>
							The idea editor is where all of the fields of an idea are viewed and edited. It also
							includes things like exporting the idea&apos;s script, viewing a thumbnail on a replica of
							the YouTube homepage, and more.
						</p>
						<p>
							The editor includes a bunch of useful QOL features that make it easy to work with ideas,
							such as autosaving, the ability to autofill an idea&apos;s fields (including the script and
							checklist items) from a template, and so much more.
						</p>
						<h3 className="text-xl font-semibold font-header text-foreground mt-6">The overview section</h3>
						...
						<ul className="list-disc pl-4.5 lg:pl-6 space-y-2">
							...
							<li>
								...
								a <CirclesThreeIcon className="inline size-4 text-foreground mb-1" weight="duotone" />{" "}
								icon is shown, indicating that there are more than one platforms selected.
							</li>
						</ul>
						...
						/>
						<p>
							The thumbnails section is where users can upload, share, and preview their thumbnails. It
							includes a few different features:
						</p>
						...
						<p>
							The custom fields section is where users can define their own fields for ideas, allowing for
						...
						<p>
							A checklist with drag and drop reordering that can be used to track the progress of an idea.
							This is especially useful for ideas that have a lot of steps or tasks that need to be
							completed before they can be considered finished.
						</p>
						<p className="text-foreground font-bold">
							<WrenchIcon className="inline mr-1 mb-0.5" weight="duotone" />
							WIP features
						</p>
						<ul className="list-disc pl-6 space-y-2">
							<li>
								<strong className="font-bold text-yellow">Due dates:</strong> Users will soon be able to
								set due dates for checklist items, which will be displayed in the content calendar.
							</li>
							<li>
								<strong className="font-bold text-yellow">Task assignment:</strong> With the release of
								team collaboration features, team members will be able to assign tasks to each other,
								making it easier to track who is responsible for what.
							</li>
						</ul>
						<h3 className="text-xl font-semibold font-header text-foreground mt-6">The script section</h3>
						<p>
							The script section features a full-fledged rich script editor, word and character counts,
							autosaving, and more. You can read more about it in the Script Editor feature section of the
							features list.
						</p>
						<p>On top of these features, users can also export a script to a txt, docx, or pdf file.</p>
					</div>
				</div>
			</CDialogContent>
		</CDialog>
