...
const buttonVariants = cva(
	"relative group inline-flex flex-row items-center justify-center whitespace-nowrap font-sans transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-blue/50 focus-visible:ring-[2px] aria-invalid:ring-red/75/20 dark:aria-invalid:ring-red/75/40 aria-invalid:border-red",
	{
		variants: {
			variant: {
				default:
